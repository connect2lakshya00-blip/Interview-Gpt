...
// For serverless (Vercel), connect on each request
// For local dev, connect once and listen
if (process.env.VERCEL) {
  // Running on Vercel - export app for serverless
  connectDB();
  module.exports = app;
} else {
  // Running locally - connect and listen
  connectDB()
    .then(() => {
